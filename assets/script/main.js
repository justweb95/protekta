...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const galleryOpenNavBtn = document.getElementById('gallery-open-nav');
  const galleryOpenMobileBtn = document.getElementById('gallery-open-mobile');
  ...
  galleryOpenBtn.addEventListener('click', openGalleryDialog);
  galleryOpenNavBtn.addEventListener('click', openGalleryDialog);
  galleryOpenMobileBtn.addEventListener('click', openGalleryDialog);
